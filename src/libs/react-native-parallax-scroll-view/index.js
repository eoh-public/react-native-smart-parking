...
const noRender = () => <View style={styles.displayNone} />;
...
class ParallaxScrollView extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.state.offsetScrollY > 0 && maybeStickyHeader}
      </View>
    );
  }
  ...
  _onScroll(e) {
    ...
    // PHI MAI fix issue foregrounf header can't click
    if (this.state.offsetScrollY * e.nativeEvent.contentOffset.y <= 0) {
      this.setState({ offsetScrollY: e.nativeEvent.contentOffset.y });
    }
          ...
          {renderFixedHeader ? (
            <Animated.View
              style={{
                ...
                zIndex: interpolate(scrollY, {
                  inputRange: [0, p],
                  outputRange: [1, -1],
                  extrapolate: 'clamp',
                }),
                ...styles.wrapAbsoblute,
              }}
            >
              {renderFixedHeader()}
            </Animated.View>
